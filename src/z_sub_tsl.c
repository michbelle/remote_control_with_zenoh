...
int main(int argc, char **argv) {
    ...
    zp_config_insert(z_loan_mut(config), Z_CONFIG_CONNECT_KEY, "tls/localhost:7447");

    // 2. Point to your Root CA certificate file
    // zp_config_insert(
    // z_loan_mut(config), 
    // Z_CONFIG_TLS_ROOT_CA_CERTIFICATE_BASE64_KEY, 
    // ""
    // );
    zp_config_insert(
    z_loan_mut(config), 
    Z_CONFIG_TLS_ROOT_CA_CERTIFICATE_KEY, 
    "/home/michele/code/remote_control_with_zenoh/cert/minica.pem"
    );
